...
export default class BattleOfBlades extends Component {
  constructor(props) {
    super(props);
    this.state = {
      startGame: false,
  ...
  _endGame(gameWon, message) {
    ...
    if (gameWon) {
        ...
        var gradientColorQueue = this.refs.mainView.state.gradientColorQueue;
        gradientColorQueue.push('blue');
        this.refs.mainView.setState({gradientColorQueue:gradientColorQueue});
    } else {
        var gradientColorQueue = this.refs.mainView.state.gradientColorQueue;
        gradientColorQueue.push('red');
        this.refs.mainView.setState({gradientColorQueue:gradientColorQueue});
    }

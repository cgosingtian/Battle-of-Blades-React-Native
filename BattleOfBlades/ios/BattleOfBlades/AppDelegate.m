...
{
  [AppHub setApplicationID:@"AYJafx8Z73rK6517GpEI"];
...
//  [AppHub presentSelectorOnViewController:rootViewController withBuildHandler:^(AHBuild *build, NSError *error) {
//    if (error || ! build) {
//      // An error occurred.
//      UIAlertView *alert = [[UIAlertView alloc] initWithTitle:error.localizedFailureReason message:error.localizedDescription delegate:nil cancelButtonTitle:@"Okay" otherButtonTitles: nil];
//      [alert show];
//    } else {
//      [_bridge reload];
//    }
...
- (NSURL *)sourceURLForBridge:(__unused RCTBridge *)bridge
{
   ...
   * folder and running
   *
   * $ react-native bundle --entry-file index.js --platform ios --dev true --bundle-output iOS/main.jsbundle
   *
   */

...
@property (nonatomic, assign) BOOL buildSelected;
@property (nonatomic, strong) NSString* currentBuildIdentifier;
  ...
  [AppHub presentSelectorOnViewController:rootViewController withBuildHandler:^(AHBuild *build, NSError *error) {
    if (error || ! build) {
      ...
      [alert show];
        ...
        UIViewController *rootViewController = [UIViewController new];
        rootViewController.view = rootView;
        [self.window.rootViewController presentViewController:rootViewController animated:NO completion:nil];
    }
  }];
...
- (NSURL *)sourceURLForBridge:(__unused RCTBridge *)bridge
{
  ...
  self.currentBuildIdentifier = build.identifier;
